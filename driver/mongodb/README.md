...
For a detailed example see: [sample_mongodb_migrator.go](https://github.com/danielfbm/migrate/blob/master/driver/mongodb/example/sample_mongdb_migrator.go)

```go
package my_mongo_db_migrator

import (
  "github.com/danielfbm/migrate/driver/mongodb"
  "github.com/danielfbm/migrate/driver/mongodb/gomethods"
  "gopkg.in/mgo.v2"
)
